...
/** Workflow instrumentation: outer invoke_workflow span wraps child spans (chat, execute_tool, etc.). */
@Service
public class WorkflowService {
  ...
  public WorkflowResponse runWorkflow(String workflowName, String userInput) {
    // WorkflowInvocation holds orchestration-level input/output; inner chat/tool calls get their own spans
